...
final_ratings = pd.read_pickle('models/user_final_rating.pkl')
lr_model_obj = pd.read_pickle('models/sentiment-classification-logistic-model.pkl')
tfidf_obj = pd.read_pickle('models/tfidf-vectorizer.pkl')
